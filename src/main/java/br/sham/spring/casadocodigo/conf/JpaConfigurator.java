...
public class JpaConfigurator {
	...
	@Bean
	public LocalContainerEntityManagerFactoryBean geEntityManagerFactoryBean(DataSource dataSource) {

		LocalContainerEntityManagerFactoryBean entityManagerFactory = new LocalContainerEntityManagerFactoryBean();

		entityManagerFactory.setPackagesToScan("br.sham.spring.casadocodigo.models");
